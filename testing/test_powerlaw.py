...
references = {
        ...
        'terrorism': {
            'discrete': True,
            'data': powerlaw.load_test_dataset('terrorism'),
            'alpha': 2.4,
            'xmin': 12,
        ...
        'cities': {
            'discrete': False,
            'data': powerlaw.load_test_dataset('cities')/10**3,
            'alpha': 2.37,
            'xmin': 52.46,
        ...
        'quakes': {
            'discrete': False,
            'data': (10**powerlaw.load_test_dataset('quakes'))/10**3,
        ...
        'surnames': {
            'discrete': False,
            'data': powerlaw.load_test_dataset('surnames')/10**3,
