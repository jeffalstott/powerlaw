...
%The maximum likelihood fit for all distributions other than the power law are found by numerical optimization, for both continuous and discrete cases. This is less of a computational concern for these distributions, since the fit needs only to be calculated once, instead of for every possible value of $x_{min}$. The default function for the numerical optimization of all fits is SciPy's fmin. Other optimizing algorithms can be passed as a function.
%
%\begin{verbatim}
%TO BE TWEAKED
