/* Generated by Cython 0.14.1 on Fri Sep  2 21:00:46 2011 */
...
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_6cplfit_DTYPE_t = { "DTYPE_t", NULL, sizeof(__pyx_t_6cplfit_DTYPE_t), 'R' };
#define __Pyx_MODULE_NAME "cplfit"
static int __pyx_module_is_main_cplfit = 0;
...
static PyObject *__pyx_pf_6cplfit_plfit_loop(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_6cplfit_plfit_loop[] = "\n    The internal loop of plfit.  Useful because it can\n    be wrapped into plfit.py for direct comparison\n    with the fortran version\n    ";
static PyMethodDef __pyx_mdef_6cplfit_plfit_loop = {__Pyx_NAMESTR("plfit_loop"), (PyCFunction)__pyx_pf_6cplfit_plfit_loop, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_6cplfit_plfit_loop)};
static PyObject *__pyx_pf_6cplfit_plfit_loop(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyArrayObject *__pyx_v_cargunique = 0;
  float __pyx_v_cx;
  float __pyx_v_cf;
  float __pyx_v_val;
  float __pyx_v_a;
  ...
  int __pyx_v_i;
  int __pyx_v_iu;
  Py_buffer __pyx_bstruct_av;
  Py_ssize_t __pyx_bstride_0_av = 0;
  Py_ssize_t __pyx_bshape_0_av = 0;
  Py_buffer __pyx_bstruct_cargunique;
  Py_ssize_t __pyx_bstride_0_cargunique = 0;
  Py_ssize_t __pyx_bshape_0_cargunique = 0;
  Py_buffer __pyx_bstruct_ksvals;
  Py_ssize_t __pyx_bstride_0_ksvals = 0;
  Py_ssize_t __pyx_bshape_0_ksvals = 0;
  Py_buffer __pyx_bstruct_data;
  Py_ssize_t __pyx_bstride_0_data = 0;
  Py_ssize_t __pyx_bshape_0_data = 0;
  Py_buffer __pyx_bstruct_czunique;
  Py_ssize_t __pyx_bstride_0_czunique = 0;
  Py_ssize_t __pyx_bshape_0_czunique = 0;
  ...
  int __pyx_t_16;
  int __pyx_t_17;
  __pyx_t_6cplfit_DTYPE_t __pyx_t_18;
  float __pyx_t_19;
  float __pyx_t_20;
  int __pyx_t_21;
  int __pyx_t_22;
  ...
  __Pyx_RefNannySetupContext("plfit_loop");
  ...
  if (unlikely(__pyx_kwds)) {
    ...
    if (unlikely(kw_args > 0)) {
      if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "plfit_loop") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    }
    __pyx_v_z = values[0];
    ...
    __pyx_v_zunique = ((PyObject *)Py_None);
    __pyx_v_argunique = ((PyObject *)Py_None);
    __pyx_v_nosmall = __pyx_k_1;
    switch (PyTuple_GET_SIZE(__pyx_args)) {
      case  4: __pyx_v_nosmall = PyTuple_GET_ITEM(__pyx_args, 3);
      case  3: __pyx_v_argunique = PyTuple_GET_ITEM(__pyx_args, 2);
      case  2: __pyx_v_zunique = PyTuple_GET_ITEM(__pyx_args, 1);
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("cplfit.plfit_loop");
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __Pyx_INCREF(__pyx_v_zunique);
  __Pyx_INCREF(__pyx_v_argunique);
  __pyx_bstruct_ksvals.buf = NULL;
  __pyx_bstruct_av.buf = NULL;
  __pyx_bstruct_data.buf = NULL;
  __pyx_bstruct_czunique.buf = NULL;
  __pyx_bstruct_cargunique.buf = NULL;
 ...
 */
    ...
    __pyx_t_7 = PyEval_CallObjectWithKeywords(__pyx_t_5, ((PyObject *)__pyx_t_4), ((PyObject *)__pyx_t_6)); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_7);
    ...
    if (PyTuple_CheckExact(__pyx_t_7) && likely(PyTuple_GET_SIZE(__pyx_t_7) == 2)) {
      ...
      __Pyx_GOTREF(__pyx_t_5);
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      __pyx_t_6 = __Pyx_UnpackItem(__pyx_t_5, 0); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_6);
      __pyx_t_4 = __Pyx_UnpackItem(__pyx_t_5, 1); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
      if (__Pyx_EndUnpack(__pyx_t_5, 2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __Pyx_DECREF(__pyx_v_zunique);
      __pyx_v_zunique = __pyx_t_6;
      __pyx_t_6 = 0;
 ...
 */
  ...
  __pyx_t_8 = PyObject_Length(__pyx_t_7); if (unlikely(__pyx_t_8 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 48; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __pyx_v_lxm = __pyx_t_8;
 ...
 */
  ...
  __Pyx_INCREF(__pyx_t_7);
  __pyx_t_8 = PyObject_Length(__pyx_t_7); if (unlikely(__pyx_t_8 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 49; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
 ...
 */
  ...
  __pyx_t_9 = ((PyArrayObject *)__pyx_t_7);
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_ksvals, (PyObject*)__pyx_t_9, &__Pyx_TypeInfo_nn___pyx_t_6cplfit_DTYPE_t, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
      __pyx_v_ksvals = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None); __pyx_bstruct_ksvals.buf = NULL;
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 50; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    } else {__pyx_bstride_0_ksvals = __pyx_bstruct_ksvals.strides[0];
      __pyx_bshape_0_ksvals = __pyx_bstruct_ksvals.shape[0];
    }
  }
  __pyx_t_9 = 0;
 ...
 */
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_av, (PyObject*)__pyx_t_10, &__Pyx_TypeInfo_nn___pyx_t_6cplfit_DTYPE_t, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
      __pyx_v_av = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None); __pyx_bstruct_av.buf = NULL;
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 51; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    } else {__pyx_bstride_0_av = __pyx_bstruct_av.strides[0];
      __pyx_bshape_0_av = __pyx_bstruct_av.shape[0];
    }
  }
  __pyx_t_10 = 0;
 ...
 */
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_data, (PyObject*)__pyx_t_11, &__Pyx_TypeInfo_nn___pyx_t_6cplfit_DTYPE_t, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) {
 ...
 */
  ...
  __pyx_t_12 = ((PyArrayObject *)__pyx_v_zunique);
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_czunique, (PyObject*)__pyx_t_12, &__Pyx_TypeInfo_nn___pyx_t_6cplfit_DTYPE_t, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) {
      __pyx_v_czunique = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None); __pyx_bstruct_czunique.buf = NULL;
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 53; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    } else {__pyx_bstride_0_czunique = __pyx_bstruct_czunique.strides[0];
      __pyx_bshape_0_czunique = __pyx_bstruct_czunique.shape[0];
    }
  }
  __pyx_t_12 = 0;
  __Pyx_INCREF(__pyx_v_zunique);
 ...
 */
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_cargunique, (PyObject*)__pyx_t_13, &__Pyx_TypeInfo_nn___pyx_t_6cplfit_DTYPE_t, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) {
      __pyx_v_cargunique = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None); __pyx_bstruct_cargunique.buf = NULL;
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 54; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    } else {__pyx_bstride_0_cargunique = __pyx_bstruct_cargunique.strides[0];
      __pyx_bshape_0_cargunique = __pyx_bstruct_cargunique.shape[0];
    }
  }
  __pyx_t_13 = 0;
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_7);
    __pyx_t_15 = __Pyx_PyInt_AsInt(__pyx_t_7); if (unlikely((__pyx_t_15 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 58; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
    __pyx_v_xm = __pyx_t_15;
 ...
 */
    ...
    if (__pyx_t_15 < 0) __pyx_t_15 += __pyx_bshape_0_czunique;
    __pyx_v_xmin = (*__Pyx_BufPtrCContig1d(__pyx_t_6cplfit_DTYPE_t *, __pyx_bstruct_czunique.buf, __pyx_t_15, __pyx_bstride_0_czunique));
 ...
 */
      ...
      if (__pyx_t_17 < 0) __pyx_t_17 += __pyx_bshape_0_data;
      __pyx_t_18 = (*__Pyx_BufPtrCContig1d(__pyx_t_6cplfit_DTYPE_t *, __pyx_bstruct_data.buf, __pyx_t_17, __pyx_bstride_0_data));
 ...
 */
    ...
    if (__pyx_t_16 < 0) __pyx_t_16 += __pyx_bshape_0_av;
    *__Pyx_BufPtrCContig1d(__pyx_t_6cplfit_DTYPE_t *, __pyx_bstruct_av.buf, __pyx_t_16, __pyx_bstride_0_av) = __pyx_v_a;
 ...
 */
      ...
      __pyx_v_cx = (((float)(__pyx_v_i - __pyx_v_xm)) / __pyx_v_nj);
 ...
 */
      ...
      __pyx_t_18 = (*__Pyx_BufPtrCContig1d(__pyx_t_6cplfit_DTYPE_t *, __pyx_bstruct_data.buf, __pyx_t_22, __pyx_bstride_0_data));
 ...
 */
      ...
      if (__pyx_t_23 < 0) __pyx_t_23 += __pyx_bshape_0_ksvals;
      __pyx_t_2 = ((*__Pyx_BufPtrCContig1d(__pyx_t_6cplfit_DTYPE_t *, __pyx_bstruct_ksvals.buf, __pyx_t_23, __pyx_bstride_0_ksvals)) < __pyx_v_val);
      if (__pyx_t_2) {
 ...
 */
        ...
        if (__pyx_t_24 < 0) __pyx_t_24 += __pyx_bshape_0_ksvals;
        *__Pyx_BufPtrCContig1d(__pyx_t_6cplfit_DTYPE_t *, __pyx_bstruct_ksvals.buf, __pyx_t_24, __pyx_bstride_0_ksvals) = __pyx_v_val;
        goto __pyx_L15;
      }
      __pyx_L15:;
    }
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_av);
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_cargunique);
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_ksvals);
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_data);
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_czunique);
...
#endif
{
  ...
  __pyx_refnanny = __Pyx_RefNanny->SetupContext("PyMODINIT_FUNC PyInit_cplfit(void)", __LINE__, __FILE__);
  #endif
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("cplfit"), __pyx_methods, __Pyx_DOCSTR(__pyx_k_15), 0, PYTHON_API_VERSION);
  #else
 ...
 * import time
 */
  __pyx_t_1 = __Pyx_Import(((PyObject *)__pyx_n_s__cmath), 0); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 28; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  __pyx_t_1 = __Pyx_Import(((PyObject *)__pyx_n_s__time), 0); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  __pyx_t_2 = 0;
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_6cplfit_plfit_loop, NULL, __pyx_n_s__cplfit); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_2);
  if (__pyx_m) {
    __Pyx_AddTraceback("init cplfit");
